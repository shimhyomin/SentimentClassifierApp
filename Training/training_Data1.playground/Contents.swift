...
let trainingData = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/shm/iOS_SentimentClassifierApp/Data/Data1/trainingData(1).csv"))
let testingData = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/shm/iOS_SentimentClassifierApp/Data/Data1/testData.csv"))
//let testingData = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/shm/iOS_SentimentClassifierApp/Data/Data1/trainingData(1).csv"))
...
try sentimentClassifier.write(to: URL(fileURLWithPath: "//Users/shm/iOS_SentimentClassifierApp/Training/SentimentClassifier(1).mlmodel"),
                              metadata: metadata)

...
let trainingData = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/shm/iOS_SentimentClassifierApp/Data/Data3/trainingData(3).csv"))
let testingData = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/shm/iOS_SentimentClassifierApp/Data/Data3/testData.csv"))
...
try sentimentClassifier.write(to: URL(fileURLWithPath: "//Users/shm/iOS_SentimentClassifierApp/Training/SentimentClassifier(3).mlmodel"),
                              metadata: metadata)
